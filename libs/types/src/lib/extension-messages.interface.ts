...
export type MESSAGE_ON_WORD_SHOWN = {
  type: typeof EXTENSION_MESSAGES.ON_WORD_SHOWN,
  trigger: MESSAGE_SHOW_WORD['type'],
  id: string, categoryId: string
}
...
export type MESSAGE_DISABLE_SHOW_WORD = {
  type: typeof EXTENSION_MESSAGES.DISABLE_SHOW_WORD ;
...
export interface MESSAGES {
  ...
  [EXTENSION_MESSAGES.ON_WORD_SHOWN]: MESSAGE_ON_WORD_SHOWN,
  ...
  [EXTENSION_MESSAGES.DISABLE_SHOW_WORD]: MESSAGE_DISABLE_SHOW_WORD,
